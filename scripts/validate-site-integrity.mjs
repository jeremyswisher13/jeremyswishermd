...
const expectedAssetCacheKey = '20260905-print1';
const expectedScriptCacheKey = '20260905-print1';
...
for (const file of htmlFiles) {
    ...
    if (!/<noscript><link rel="stylesheet" href="[^"]*navigation-nojs\.css\?v=20260905-print1"><\/noscript>/.test(html)) {
